...
class TheloaiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admintt.theloai.index')->with(compact('theloai'));
    }
    ...
    {
        return view('admintt.theloai.create');
    }
    ...
    public function store(Request $request)
    {
        $data = $request->validate(
            ...
            [
                ...
                'slug_theloai.unique' => 'Slug thể loại đã có, điền tên khác nhé!',
                'tentheloai.unique' => 'Tên thể loại đã có, xin điền tên khác nhé!',
    ...
    public function edit($id)
    {
        ...
        return view('admintt.theloai.edit')->with(compact('theloai'));
    }
