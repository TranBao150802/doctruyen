...
<!-- calendar -->
<link rel="stylesheet" href={{("frontend/css/monthly.css")}}>
<!-- //calendar -->
<!-- //font-awesome icons -->
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        <li>
            <input type="text" class="form-control search" placeholder=" nhập từ khóa">
        </li>
        <!-- user login dropdown start-->
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img src="https://i.pinimg.com/280x280_RS/1f/9b/fb/1f9bfb1e2090cdd9eeb01f4d454a4cea.jpg">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{ url('/home') }}">
                        ...
                        <span>Admin quản lý truyện</span>
                    </a>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('danhmuctruyen.create')}}">Thêm danh mục</a></li>
                        <li><a href="{{route('danhmuctruyen.index')}}">Liệt kê danh mục</a></li>
                    </ul>
                </li>
                <li>
 ...
 <!-- footer -->
          <div class="footer">
            <div class="wthree-copyright">
              <p>© Admin <a href="#">{{ Auth::user()->name }} Đang hoạt động</a></p>
            </div>
          </div>
  <!-- / footer -->
</section>
